...
def create_reg_datasets(batch_size: int, data_path: str, selected_frames: List[int], img_x: int, img_y: int) -> Tuple[DataLoader, DataLoader, DataLoader]:
    ...
    train_set = Dataset3DCNN(data_path, train_list, train_label, selected_frames, transform=transform)
...
def create_cls_datasets(batch_size: int, data_path: str, class_labels: List[str], selected_frames: List[int], img_x: int, img_y: int) -> Tuple[DataLoader, DataLoader, DataLoader]:
